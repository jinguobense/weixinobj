...
Page({
  ...
  getshareimg() {
    ...
    ctx.setFontSize(12)
    var discountText = '还差'+info.missNum + "人拼团成功";
    //var discountText = info.tourDesc;
    var bdColor = '#E22405';
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (res.data.result == 0) {
          ...
          wx.navigateTo({
            url: '../suredd/suredd?obj=' + obj + '&type=qupin',
          })
        } else {
          wx.showToast({
      ...
      success: function (res) {
        ...
        if (res.data.result == 0){
          ...
          _this.setData({
            ...
            guigelist: res.data.goodsSkuList,
            hpl: hpl
          })
          _this.countDown();
          setTimeout(function () {
