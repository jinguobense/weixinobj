...
Page({
      ...
      wx.request({
        ...
        success: function (res) {
          ...
          if (res.data.result == 0) {
            ...
            wx.navigateTo({
              url: '../suredd/suredd?obj=' + obj + '&type=onepin',
            })
            _this.closechoosebox();
          } else {
            wx.showToast({
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      path: "/pages/index/index?goodsid=" + goodsid + '&type=3&name=' + name + '&goodsimg=' + info.goodsImg[0] + '&userimg=' + userimg,
      imageUrl: shareimg,
      title: info.shopName
    };
  }
