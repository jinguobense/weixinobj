...
Page({
  ...
  getshareimg(){
    ...
    ctx.setFontSize(12)
    var discountText = info.tourNum + "人团";
    var bdColor = '#E22405';
      ...
      wx.request({
        ...
        success: function (res) {
          ...
          if (res.data.result == 0) {
            var obj = JSON.stringify(res.data)
            wx.navigateTo({
              url: '../suredd/suredd?obj=' + obj + '&type=kaipin',
            })
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      path: "/pages/index/index?goodsid=" + goodsid + '&type=1&name=' + name + '&goodsimg=' + info.goodsImg[0] + '&userimg='+userimg,
      imageUrl: shareimg,
      title: info.shopName
    };
  }
