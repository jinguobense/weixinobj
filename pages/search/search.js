...
Page({
  ...
  lishisearch(e) {
    ...
    if(this.data.shopid){
      ...
      wx.navigateTo({
        url: '../searchend/searchend?search=' + list[index] + '&shopid='+shopid,
      })
    }else{
      wx.navigateTo({
  ...
  tuijiansearch(e){
    ...
    if (this.data.shopid) {
      var shopid = this.data.shopid;
      wx.navigateTo({
        url: '../searchend/searchend?search=' + _this.data.tuijianlist[index] + '&shopid=' + shopid,
      })
    } else {
      wx.navigateTo({
  ...
  tosearchend(){
    ...
    if (this.data.shopid) {
      var shopid = this.data.shopid;
      wx.navigateTo({
        url: '../searchend/searchend?search=' + _this.data.searchcon + '&shopid=' + shopid,
      })
    } else {
      wx.navigateTo({
